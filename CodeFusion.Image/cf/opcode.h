...
#define INST_INT ((uint8_t)48)
#define INST_JMP ((uint8_t)49)
#define INST_JMP_ZERO ((uint8_t)50)
#define INST_JMP_NOT_ZERO ((uint8_t) 51)
#define INST_CALL ((uint8_t)52)
#define INST_VCALL ((uint8_t)53)
#define INST_RET ((uint8_t)54)
#define INST_LOAD_MEMORY ((uint8_t)55)
